...
use tsuru_challenge::{PcapIterator, Timestamp, build_quote_iterator, open_mmaped_file};
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("PCAP iterator", |b| {
        b.iter(|| {
            let mmap = open_mmaped_file(black_box("mdf-kospi200.20110216-0.pcap")).unwrap();
